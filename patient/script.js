...
async function enter(a){if(a.role!="patient")throw new Error("Use a patient account.");apply(a);document.getElementById("authScreen").classList.add("hidden");document.getElementById("app").classList.remove("hidden");await Promise.all([loadDoctors(),loadAppointments(),loadPrescriptions()])}
function page(id){
